...
export const MOCK_DECISIONS: Decision[] = [
  ...
  { id: '2', communityId: '1', title: 'Emergency Fund for Members', description: 'Set aside KSh 50,000 from the community fund as an emergency medical fund that members can access interest-free.', fundingAmount: 50000, proposedBy: 'Wanjiku M.', votesFor: 41, votesAgainst: 3, totalMembers: 47, status: 'active', createdAt: '2025-04-28', endsAt: '2026-08-12' },
