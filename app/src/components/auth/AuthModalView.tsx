  ...
  return (
    ...
    >
      <div
        ...
        className="relative flex w-full max-h-[100dvh] max-w-md flex-col overflow-y-auto rounded-t-2xl bg-card text-foreground shadow-deep sm:max-h-[min(42rem,calc(100dvh-3rem))] sm:rounded-2xl"
      >
