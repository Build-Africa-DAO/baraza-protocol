...
const steps = [
  { icon: Link2, title: "Connect your account", desc: "Use a supported account to become the founding organiser." },
  { icon: ShieldCheck, title: "Set basics & rules", desc: "Name your chama, pick a type, set monthly dues in KES, and define quorum, approval, and voting period." },
