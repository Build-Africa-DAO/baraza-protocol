...
const platformLinks = [
  {
    ...
    detail: "Browse groups by purpose, location, and how members contribute.",
    to: "/communities",
  },
  {
    icon: WalletCards,
  ...
  },
  {
    ...
    label: "Operate",
    title: "Run group decisions",
    detail: "Track members, open decisions, balances, and money requests from the dashboard.",
    to: "/profile",
  },
];
        ...
        >
          <div className="rounded-2xl border border-primary/20 bg-card p-5 shadow-[var(--shadow-card)] md:p-6">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground md:text-base md:leading-7">
              Visitors can understand the model, organisers can start a group, and members can
