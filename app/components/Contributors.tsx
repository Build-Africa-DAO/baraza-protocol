...
const CONTRIBUTORS = [
  {
    ...
    votes: 29,
    payments: 23,
    bio: "Software Engineer | Web3 | Podcaster — Fluent in English, Swahili and French",
    color: "#f59e0b",
    initials: "AK",
    joinedAgo: "18mo",
  ...
  },
  {
    ...
    votes: 28,
    payments: 21,
    bio: "DAO Operations Contributor. Graphics, Content and Template Creator. Data Entry...",
    color: "#10b981",
    initials: "WM",
    joinedAgo: "14mo",
  ...
  },
  {
    ...
    votes: 22,
    payments: 18,
    bio: "Community Operations & Management | DAO Tooling | Content & Communications...",
    color: "#6366f1",
    initials: "OB",
    joinedAgo: "11mo",
  ...
  },
  {
    ...
    votes: 15,
    payments: 12,
    bio: "Polyglot fluent in English, Swahili and Arabic. I help DAOs and crypto projects...",
    color: "#e11d48",
    initials: "FH",
    joinedAgo: "9mo",
