...
contract DeployContracts is Script {
    ...
    function run() public {
        ...
        address barazaRewardsRecipient = _getKey("BarazaRewardsRecipient");
    ...
    function _deployUpgrade(
        ...
        address barazaRewardsRecipient,
        uint256 chainID
    ) private {
        ...
        console2.logAddress(barazaRewardsRecipient);
        ...
        address managerImpl =
            address(new Manager(tokenImpl, metadataImpl, auctionImpl, treasuryImpl, governorImpl, barazaRewardsRecipient));
