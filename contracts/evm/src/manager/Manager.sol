...
contract Manager is IManager, VersionedContract, UUPS, Ownable, ManagerStorageV1 {
    ...
    /// @notice The address to send Baraza DAO rewards to
    address public immutable barazaRewardsRecipient;
    ...
    constructor(
        ...
        address _barazaRewardsRecipient
    ) payable initializer {
        ...
        barazaRewardsRecipient = _barazaRewardsRecipient;
    }
    ...
    /// @param _newOwner The owner address to set (will be transferred to the Baraza DAO once its deployed)
    ...
    /// @notice If an implementation is registered by the Baraza DAO as an optional upgrade
    ...
    /// @notice Called by the Baraza DAO to offer implementation upgrades for created DAOs
    /// @param _baseImpl The base implementation address
    /// @param _upgradeImpl The upgrade implementation address
    ...
    /// @notice Called by the Baraza DAO to remove an upgrade
    /// @param _baseImpl The base implementation address
    /// @param _upgradeImpl The upgrade implementation address
