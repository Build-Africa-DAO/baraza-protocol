...
contract AuctionTest is BarazaTest {
    ...
    uint16 internal barazaRewardBPS = 300;
    ...
    function setUp() public virtual override {
        ...
        rewardImpl = new Auction(address(manager), address(rewards), weth, barazaRewardBPS, referralRewardBPS);
    }
    ...
    function test_BarazaAndReferralReward() external {
        // Setup
        deployMock();
    ...
    function test_FounderBarazaAndReferralReward() external {
        // Setup
        deployAltMock(founder, 500);
    ...
    function test_FounderBarazaAndReferralRewardWithSmallAmount() external {
        // Setup
        deployAltMock(founder, 500);
