...
contract GovTest is BarazaTest, GovernorTypesV1 {
    ...
    function test_MismatchingHashesFromIncorrectProposer() public {
        deployMock();

        // Mint a token to voter 1 so the proposal passes the threshold.
        mintVoter1();
