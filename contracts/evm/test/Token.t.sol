...
contract TokenTest is BarazaTest, TokenTypesV1 {
    ...
    function test_FounderShareAllocationFuzz(uint256 f1Percentage, uint256 f2Percentage, uint256 f3Percentage) public {
        ...
        f1Percentage = bound(f1Percentage, 1, 96);
        f2Percentage = bound(f2Percentage, 1, 97 - f1Percentage);
        f3Percentage = bound(f3Percentage, 1, 98 - f1Percentage - f2Percentage);
    ...
    function test_SingleMintCannotMintReserves(address _minter, uint256 _reservedUntilTokenId) public {
        _reservedUntilTokenId = bound(_reservedUntilTokenId, 1, 128);
        deployAltMock(_reservedUntilTokenId);
