...
| `app/src/akili/` | Akili Council — 5 specialised one-shot agents (Amara, Kofi, Zara, Nia, Seku) |
...
- **Akili Council** (`app/src/akili/`) — 5 specialised one-shot agents: Amara (community intel), Kofi (governance), Zara (compliance), Nia (research), Seku (content). Invoke via `invokeCouncilAgent(name, message)`.
